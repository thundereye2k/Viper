 ...
 */
final class CustomCommand extends Command implements PluginIdentifiableCommand {
    private final Plugin owningPlugin;
    private TabCompleter completer;
    private CommandExecutor executor;

    protected CustomCommand(String name, Plugin owner) {
        super(name);
        executor = owner;
        owningPlugin = owner;
        usageMessage = "";
     ...
     * list has not been found, will default to standard player name completion
     * in {@link Command#tabComplete(CommandSender, String, String[])}.
     * <p/>
